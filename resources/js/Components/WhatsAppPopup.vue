<template>
  <a :href="whatsappLink" target="_blank" rel="noopener noreferrer"
     class="whatsapp-button fixed bottom-6 right-6 z-50" title="Fale conosco no WhatsApp">
...
const whatsappLink = computed(() =>
  `https://wa.me/5551992824071?text=${encodeURIComponent('Olá! Gostaria de tirar uma dúvida.')}`
);
</script>
